define(['jBootValidator', 'sinon'], function (JBootValidator, Sinon) {
    describe('jbootvalidator(required) textarea', function () {
        var form;
        ...
        it('should add has-error class when required textarea is blank', function () {
            var formControl = textArea(true);
        ...
        it('should handle changes to the required attribute', function () {
            var formControl = textArea(false);
            var formGroup = formGroupDiv()
                .append(formControl);
        ...
        it('should remove help-block when the required issue is resolved', function () {
            var formControl = textArea(true).val('present');
